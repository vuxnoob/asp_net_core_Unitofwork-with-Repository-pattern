...
namespace asp_net_core_Unitofwork_with_Repository_pattern.DBContext
{
	public class NorthwindContext : DbContext
	{
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=localhost,1433;User=sa;Password=215162459;Database=Northwind;");
            }
        }
